...
(
  id                         bigint auto_increment comment '主键',
  bus_station_name           varchar(200)                       null comment '公交站名',
  bus_line_go_through        varchar(200)                       null comment '途径线路, 用","分割',
  bus_line_go_through_number int                                null comment '途经线路数量',
  bus_station_address        varchar(200)                       null comment '站点地址',
  is_del                     int      default 0                 null comment '逻辑标识符, 0-未删除 1-已删除',
  create_time                datetime default current_timestamp null comment '创建时间',
